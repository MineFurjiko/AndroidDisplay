...
cc.Class({
    ...
    onLoad() {
        ...
        let hotUpdateHost = cc.sys.localStorage.getItem('hotUpdateHost');
        if (hotUpdateHost == '' || hotUpdateHost == null) {
            this.hostInput.string = '127.0.0.1';
        } else {
            this.hostInput.string = hotUpdateHost;
        }
    ...
    onLoadButtomClick() {
        ...
        let hotUpdateHost = this.hostInput.string;
        cc.sys.localStorage.setItem('hotUpdateHost', hotUpdateHost);
    }
});
